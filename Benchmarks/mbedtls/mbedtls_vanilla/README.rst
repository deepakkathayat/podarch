...
PodArch
=======
A -static flag has been added in the Makefiles at top-level, programs/ and tests/ sub-directories for linking statically.
To run the test suite after compilation you may also use "test_vanilla.sh" script in tests directory.
For pod sealing refer to mbedtls_pod folder.
